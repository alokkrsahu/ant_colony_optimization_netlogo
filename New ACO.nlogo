...
(patch 14 51) (patch 27 45) (patch 34 48) (patch 16 26) (patch 4 27)
(patch 37 27) (patch 41 22) (patch 31 52) (patch 28 30) (patch 29 31)
(patch 23 32) (patch 24 52) (patch 35 16) (patch 24 56) (patch 52 30)
...
to update-pheromone
  let l get-unique-link visited
  let tl int tour-length
  foreach l [ x ->
...
to update-best-pheromone
  let l get-unique-link best-visited
  let tl int best-tour
  foreach l [ x ->
    ask link item 0 x item 1 x [set pheromone pheromone + ( 1 / tl)]]
  set city-here 0
  if cnt = 0 [ set best-tour tour-length set best-visited visited set cnt 1 set best-monitor lput tour-length best-monitor print best-visited print best-tour ]
